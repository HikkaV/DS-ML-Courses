...
As the second part of course, students will have a hands on introduction to basic machine learning algorithms and core machine learning concepts. The course won't dig in depth of the algorithms's work, but we badly encourage you to checkout useful references that can be found in this wiki. Finally, the students will have a chance to work with such packages as: Scikit-learn, Keras and Tensorflow.
